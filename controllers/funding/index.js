...
module.exports = (pages, sectionPath, sectionId) => {
    ...
    router
        ...
        .post(
            ...
            (req, res) => {
                ...
                freeMaterialsLogic.modifyItems(
                    req,
                    freeMaterialsLogic.orderKey,
                    code
                );
                    ...
                    json: () => {
                        req.session.save(() => {
                            res.send({
                                ...
                                allOrders:
                                    req.session[freeMaterialsLogic.orderKey]
                            });
                        });
                    }
                });
     ...
     */
    const validators = freeMaterialsLogic.formFields
        ...
        .map(field => {
            return body(field.name)
                ...
                .custom((value, { req }) => {
                    ...
                    let errorMessage = req.i18n.__(
                        'global.forms.missingFieldError',
                        fieldName
                    );
                    // Validate field
    ...
    const makeOrderText = (items, details) => {
        ...
        for (let code in items) {
            if (items[code].quantity > 0) {
                text += `\t- x${items[code].quantity} ${code}\t (item: ${
                    items[code].name
                })\n`;
            }
        }
    ...
    router
        ...
        .get(cached.csrfProtection, (req, res) => {
            ...
            res.render(freeMaterials.template, {
                ...
                copy: lang,
                description:
                    'Order items free of charge to acknowledge your grant',
            ...
            if (!errors.isEmpty()) {
                ...
                if (req.body.skipEmail) {
                    ...
                    let storeOrderData = (items, details) => {
                        ...
                        let postcodeArea = details.yourPostcode
                            .replace(/ /g, '')
                            .toUpperCase();
                                ...
                                storeOrderData(items, details)
                                    ...
                                    .catch(error => {
                                        ...
                                        Raven.captureMessage(
                                            'Error logging material order in database',
                                            {
                                                extra: error,
                                                tags: {
