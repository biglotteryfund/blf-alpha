...
const digitalFundingForm = require('./digital-fund/form-model');
...
module.exports = ({ router }) => {
    ...
    if (appData.isNotProduction) {
        ...
        router.use('/digital-fund-strand-1', initFormRouter(digitalFundingForm(1)));
        router.use('/digital-fund-strand-2', initFormRouter(digitalFundingForm(2)));
    }
