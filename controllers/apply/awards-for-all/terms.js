...
module.exports = {
    introduction: {
        en: `
            <p>By submitting an application to The National Lottery Community Fund, the organisation named in the application (referred to as “you” in these Terms and Conditions) agrees, if awarded a grant, to:</p>
            ...
            <p>You acknowledge that we are entitled to suspend or terminate the grant and/or require you to repay all or any of the grant in any of the following situations. You must let us know if any of these situations have occurred or are likely to occur:</p>
    ...
    footer: {
        en: `
            ...
            <p>Further details of how your information will be used by us and these fraud prevention agencies, your data protection rights and how to contact us, can be found in our full <a href="https://www.tnlcommunityfund.org.uk/data-protection">Data Protection and Privacy Notice</a>. Contact us to request a hard copy by telephoning our advice line on 0345 4 10 20 30, or by writing to Customer Services, The National Lottery Community Fund, 2 St James’ Gate, Newcastle upon Tyne, NE1 4BE.</p>
            <p>When you submit this form, the Terms and Conditions as agreed to above become binding.</p>
            <p>After clicking submit, you will not be able to edit any information in this form. Please ensure you are finished editing before you click submit. If you would like to continue editing please click cancel.</p>
            <p>If we are unable to process your application due to missing or incorrect information, we will get in touch. You will have two weeks to provide the missing information or we will not proceed with your application.</p>
        `,
        cy: ''
    }
};
