...
module.exports = function ({
    ...
    const form = {
        ...
        featuredErrorsAllowList: compact([
            { fieldName: 'projectLocationPostcode', includeBase: true },
            { fieldName: 'projectTotalCost', includeBase: true },
            { fieldName: 'projectStartDate', includeBase: true },
            { fieldName: 'projectSpend', includeBase: true },
            { fieldName: 'projectTotalCosts', includeBase: true },
            { fieldName: 'yourIdeaProject', includeBase: true },
            { fieldName: 'yourIdeaCommunity', includeBase: true },
            { fieldName: 'yourIdeaActivities', includeBase: true },
            { fieldName: 'projectOrganisation', includeBase: true },
            { fieldName: 'beneficiariesGroupCheck', includeBase: true },
            { fieldName: 'organisationDifferentName', includeBase: true },
            { fieldName: 'organisationStartDate', includeBase: true },
            { fieldName: 'organisationSupport', includeBase: true },
            { fieldName: 'organisationVolunteers', includeBase: true },
            { fieldName: 'organisationFullTimeStaff', includeBase: true },
            { fieldName: 'accountingYearDate', includeBase: true },
            { fieldName: 'totalIncomeYear', includeBase: true },
            { fieldName: 'mainContactName', includeBase: true },
            { fieldName: 'mainContactDateOfBirth', includeBase: true },
            { fieldName: 'mainContactAddress', includeBase: true },
            { fieldName: 'mainContactEmail', includeBase: true },
            { fieldName: 'mainContactPhone', includeBase: true },
            { fieldName: 'seniorContactRole', includeBase: true },
            { fieldName: 'seniorContactName', includeBase: true },
            { fieldName: 'seniorContactDateOfBirth', includeBase: true },
            { fieldName: 'seniorContactAddress', includeBase: true },
            { fieldName: 'seniorContactEmail', includeBase: true },
            { fieldName: 'seniorContactPhone', includeBase: true },
            { fieldName: 'termsAgreement1', includeBase: true },
            { fieldName: 'termsAgreement2', includeBase: true },
            { fieldName: 'termsAgreement3', includeBase: true },
            { fieldName: 'termsAgreement4', includeBase: true },
            { fieldName: 'termsAgreement5', includeBase: true },
            { fieldName: 'termsAgreement6', includeBase: true },
            { fieldName: 'termsPersonName', includeBase: true },
            { fieldName: 'termsPersonPosition', includeBase: true },
        ]),
        summary: summary(),
        schemaVersion: 'v1.0',
        forSalesforce() {
