...
function mockFullForm({ country, organisationType, companyNumber = null, charityNumber = null }) {
    return {
        ...
        'your-idea-project': faker.lorem.paragraphs(4),
        'your-idea-priorities': faker.lorem.paragraphs(4),
        'your-idea-community': faker.lorem.paragraphs(4),
        ...
        'main-contact-name': faker.name.findName(),
        ...
        'legal-contact-name': faker.lorem.words(5),
