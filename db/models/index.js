...
const { PendingApplication, SubmittedApplication, ApplicationExpirations } = require('./applications');
...
const db = {
    ...
    ApplicationExpirations: ApplicationExpirations.init(sequelize, Sequelize),
